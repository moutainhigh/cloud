package com.smart4y.cloud.core.infrastructure.toolkit.mock;
 ...
 * 随机生成工具类
 */
public final class MockHelper extends RandomStringUtils {
    ...
    private static final String[] pAt = {"京", "津", "冀", "晋", "蒙", "辽", "吉", "黑", "沪", "苏", "浙", "皖", "闽", "赣", "鲁", "豫", "鄂", "湘", "粤", "桂", "琼", "渝", "川", "黔", "滇", "藏", "陕", "甘", "青", "宁", "新", "台", "港", "澳"};
    /**
     * 返回中文姓名
     */
    ...
    public static String getPlateNumber() {
        ...
        return String.format("%s%s %s", first, second, carNo.toString());
    }
}