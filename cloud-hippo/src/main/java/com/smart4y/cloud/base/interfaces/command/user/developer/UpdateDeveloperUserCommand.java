package com.smart4y.cloud.base.interfaces.command.user.developer;
...
@ApiModel(value = "UpdateDeveloperUserCommand", description = "更新开发者用户")
public class UpdateDeveloperUserCommand implements Serializable {
