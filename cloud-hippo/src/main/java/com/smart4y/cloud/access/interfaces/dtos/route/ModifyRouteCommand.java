package com.smart4y.cloud.access.interfaces.dtos.route;
...
@ApiModel(value = "ModifyRouteCommand", description = "路由:修改")
public class ModifyRouteCommand implements Serializable {
