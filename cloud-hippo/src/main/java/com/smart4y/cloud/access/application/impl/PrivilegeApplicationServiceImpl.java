package com.smart4y.cloud.access.application.impl;

import com.smart4y.cloud.access.application.PrivilegeApplicationService;
import com.smart4y.cloud.access.domain.entity.*;
import com.smart4y.cloud.access.domain.service.*;
import com.smart4y.cloud.access.interfaces.dtos.element.CreateElementCommand;
import com.smart4y.cloud.access.interfaces.dtos.element.ModifyElementCommand;
...
import com.smart4y.cloud.access.interfaces.dtos.operation.ModifyOperationAuthCommand;
import com.smart4y.cloud.access.interfaces.dtos.operation.ModifyOperationOpenCommand;
import com.smart4y.cloud.access.interfaces.dtos.operation.ModifyOperationStateCommand;
...
import com.smart4y.cloud.system.infrastructure.constant.RedisConstants;
...
public class PrivilegeApplicationServiceImpl implements PrivilegeApplicationService {
    ...
    public void createMenu(CreateMenuCommand command) {
        ...
        List<RbacRolePrivilege> rolePrivileges = roleService.getRolePrivilegesByRoleId(RoleService.ADMIN_ROLE_ID);
        ...
        List<Long> newPrivilegeIds = privilegeIds.stream()
                ...
                .collect(Collectors.toList());
        roleService.grantPrivileges(RoleService.ADMIN_ROLE_ID, newPrivilegeIds);
