...
import com.smart4y.cloud.spider.infrastructure.exception.JsonExceptionHandler;
import com.smart4y.cloud.spider.infrastructure.feign.GatewayFeign;
import com.smart4y.cloud.spider.infrastructure.feign.RemotePrivilegeFeign;
import com.smart4y.cloud.spider.infrastructure.filter.GatewayContextFilter;
import com.smart4y.cloud.spider.infrastructure.filter.RemoveGatewayContextFilter;
...
import com.smart4y.cloud.spider.interfaces.rest.RouteRefreshEndpoint;
...
public class ApiConfiguration {
    ...
    public JdbcRouteDefinitionLocator jdbcRouteDefinitionLocator(InMemoryRouteDefinitionRepository repository) {
        JdbcRouteDefinitionLocator jdbcRouteDefinitionLocator = new JdbcRouteDefinitionLocator(repository);
