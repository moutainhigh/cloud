...
import com.smart4y.cloud.owl.application.impl.GiteeAuthServiceImpl;
import com.smart4y.cloud.owl.application.impl.QQAuthServiceImpl;
import com.smart4y.cloud.owl.application.impl.WechatAuthServiceImpl;
...
@Controller
@Api(tags = "用户授权中心")
public class AuthenticationOauth2Controller extends BaseController {
    ...
    public String qq(@RequestParam(value = "code") String code, @RequestHeader HttpHeaders headers) throws Exception {
        ...
        if (accessToken != null) {
            ...
            if (openId != null) {
                AddDeveloperThirdPartyCommand command = new AddDeveloperThirdPartyCommand()
                        .setAccount(openId)
                        .setPassword(openId)
                        .setAccountType("qq")
                        .setAvatar("")
                        .setNickName("");
                baseDeveloperFeign.addDeveloperThirdParty(command);
